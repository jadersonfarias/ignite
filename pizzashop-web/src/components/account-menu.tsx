...
import { StoregProfileDialog } from './store-profile-diallog'
...
export function AccountMenu() {
  ...
  const { data: managedRestaurant, isLoading: isLoadingManagedRestaurant } = useQuery({  // isLoading vai ser falso até carregar toda a requisição
